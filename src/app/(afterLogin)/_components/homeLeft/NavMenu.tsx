...
export default function NavMenu() {
    ...
    return (
        <>
            <li>
                <Link className={style.customLink} href="/home">
            ...
            <li>
                <Link className={style.customLink} href="/explore">
                    <div className={style.iconSelect}>
                        {segment === 'explore' ? (
                            <>
                                <svg
            ...
            <li>
                <Link className={style.customLink} href="/messages">
                    <div className={style.iconSelect}>
                        {segment === 'messages' ? (
                            <>
                                <svg
            ...
            {me?.id && (
                <li>
                    <Link className={style.customLink} href={`/${me?.id}`}>
                        <div className={style.iconSelect}>
                            {segment === me.id ? (
                                <>
                                    <svg
